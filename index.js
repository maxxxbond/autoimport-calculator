...
function calc() {
  ...
  if (isNaN(fixPrice) || !searchValue || isNaN(priceCar) || !auctionType || !selectedCity || (engineType === "electro" && isNaN(batteryVolume) || engineType !== "electro" && isNaN(volume)) || isNaN(yearKlaipeda)) {
    return;
  }
